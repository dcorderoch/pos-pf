    ...
    function ProviderService($http, $rootScope) {
       ...
       */
        function Create(data) {
            var response=$http({
                method:"post",
                url: $rootScope.url+"Api/Supplier/Create",
                data: data
            });
            return response;    
        }
       ...
       */      
        function Read() {
            var response=$http({
                method:"get",
                url:$rootScope.url+"Api/Supplier/GetAll"
            });
            return response;    
        }
       ...
       */
        function Delete(providerID) {
            var response=$http({
                method:"post",
                url: $rootScope.url+"Api/Supplier/Delete",
                data: {SupplerID:providerID}
            });
            return response;    
        }
       ...
       */
        function Update(data) {  
            var request = $http({
            method: "post",
            url: $rootScope.url+"Api/Supplier/Update",
            data: data
        });
            return request;
        }
