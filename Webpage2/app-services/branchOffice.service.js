    ...
    function BranchOfficeService($http, $rootScope) {
       ...
       */
        function Create(data) {
            var response=$http({
                method:"post",
                url: $rootScope.url+"Api/BranchOffice/Create",
                data: data
            });
            return response;    
        }
       ...
       */      
        function Read() {
            var response=$http({
                method:"get",
                url:$rootScope.url+"Api/BranchOffice/GetAll"
            });
            return response;    
        }
       ...
       */
        function Delete(branchOfficeID) {
            var response=$http({
                method:"post",
                url: $rootScope.url+"Api/BranchOffice/Delete",
       ...
       */
        function Update(data) {  
            var request = $http({
            method: "post",
            url: $rootScope.url+"Api/BranchOffice/Update",
            data: data
        });
            return request;
        }
